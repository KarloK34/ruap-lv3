...
<body>
<h1>Register here!</h1>
<p>M-M-M-M-MONSTER KILLLLL!!! <br> Fill in your name and email address, then click <strong>Submit</strong> to register.</p>
...
<?php
// DB connection info
$host = "moj-app-server.mysql.database.azure.com";
$user = "kspxrzcbmw";
$pwd = 'cDW$geRXsq6vZf7hl$cl';
$db = "moj-app-database";
